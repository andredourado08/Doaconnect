(function () {
    ...
    function setupDarkMode() {
        ...
        let saved = null;
        try {
            saved = localStorage.getItem('doaconnect-theme');
        } catch (_) {
            saved = null;
        }
        ...
        toggle.addEventListener('click', () => {
            ...
            try {
                localStorage.setItem('doaconnect-theme', isDark ? 'dark' : 'light');
            } catch (_) {
                // O modo ainda funciona quando o navegador bloqueia armazenamento local.
            }
